...
(deftest random-value-test
  ...
  (testing "Ensure that dates generated by the date generator are between 1800-01-01 and 2100-01-01"
      (let [generator-fn (find-generator-fn-by-name "Date / Timestamp Generator")
            column {:name "asdf" :type "asdf" :constraints {:maximum-length 10}}
            min-date (.getTime (.getTime (GregorianCalendar. 1800 1 1)))
