...
(defn create-test-tables [connection-string]
  (let [connection (DriverManager/getConnection connection-string)
        ...
        table-creation-sql ["create schema dbo"
                            "create table dbo.PurchaseType (Name varchar(50), Category varchar(50), constraint pt_unique unique (Name, Category))"
                            "create table dbo.Person (ID int primary key, Name varchar(100), BirthDate date)"
